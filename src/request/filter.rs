...
macro_rules! filter {
    ...
    (
        ...
        impl crate::request::filter::sealed::FilterPriv for $type {}
    };
}
...
macro_rules! __impl_filter_eq {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::Eq for $type {
            fn eq<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::Equals;
                crate::request::filter::Filter::new($name, op, value)
            }
        }
    };
}
...
macro_rules! __impl_filter_ne {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::NotEq for $type {
            fn ne<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::Not;
                crate::request::filter::Filter::new($name, op, value)
            }
        }
    };
...
macro_rules! __impl_filter_like {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::Like for $type {
            fn like<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::Like;
                crate::request::filter::Filter::new($name, op, value)
            }
        }

        impl crate::request::filter::NotLike for $type {
            fn not_like<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::NotLike;
                crate::request::filter::Filter::new($name, op, value)
            }
        }
    };
...
macro_rules! __impl_filter_in {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::In for $type {
            fn _in<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::In;
                crate::request::filter::Filter::new($name, op, value)
            }
        }

        impl crate::request::filter::NotIn for $type {
            fn not_in<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::NotIn;
                crate::request::filter::Filter::new($name, op, value)
            }
        }
    };
...
macro_rules! __impl_filter_cmp {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::Cmp for $type {
            fn le<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::Max;
                crate::request::filter::Filter::new($name, op, value)
            }

            fn ge<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::Min;
                crate::request::filter::Filter::new($name, op, value)
            }

            fn gt<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::GreaterThan;
                crate::request::filter::Filter::new($name, op, value)
            }

            fn lt<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::SmallerThan;
                crate::request::filter::Filter::new($name, op, value)
            }
        }
    };
...
macro_rules! __impl_filter_bit {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::BitwiseAnd for $type {
            fn bit_and<T, V>(value: V) -> crate::request::filter::Filter
            where
                T: std::fmt::Display,
                V: Into<crate::request::filter::OneOrMany<T>>,
            {
                let op = crate::request::filter::Operator::BitwiseAnd;
                crate::request::filter::Filter::new($name, op, value)
            }
        }
    };
...
macro_rules! __impl_filter_order_by {
    ($type:ty, $name:expr) => {
        impl crate::request::filter::OrderBy for $type {
            fn asc() -> crate::request::filter::Filter {
                crate::request::filter::Filter::new_order_by_asc($name)
            }

            fn desc() -> crate::request::filter::Filter {
                crate::request::filter::Filter::new_order_by_desc($name)
            }
        }
    };
}
...
///
/// ```
/// use modio::request::filter::{custom_filter, Operator};
///
...
///
/// ```
/// use modio::request::filter::{custom_filter, custom_order_by_asc, Operator};
///
...
///
/// ```
/// use modio::request::filter::{custom_filter, custom_order_by_desc, Operator};
///
