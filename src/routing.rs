...
define_routes! {
    ...
    { EditTeamMember, PUT: "/games/{}/mods/{}/team/{}", [game_id, mod_id, member_id], Token },
    { DeleteTeamMember, DELETE: "/games/{}/mods/{}/team/{}", [game_id, mod_id, member_id], Token },
    { GetModComments, GET: "/games/{}/mods/{}/comment", [game_id, mod_id], Any },
    { GetModComment, GET: "/games/{}/mods/{}/comment/{}", [game_id, mod_id, comment_id], Any },
    { DeleteModComment, DELETE: "/games/{}/mods/{}/comment/{}", [game_id, mod_id, comment_id], Token },
